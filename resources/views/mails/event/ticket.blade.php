...
<head>
    ...
    <style type="text/css">.rollover:hover .rollover-first {
        ...
        td .es-button-border:hover a.es-button-1621619122267 {
            color: #5c68e2 !important;
        }

        td .es-button-border:hover a.es-button-1621619122278 {
            color: #5c68e2 !important;
        }
...
@php
$tableClass = "mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px";
@endphp
...
<div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#FAFAFA"> <!--[if gte mso 9]>
    ...
    <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" role="none"
           style="{{$tableClass}};padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#FAFAFA">
        <tr>
            <td valign="top" style="padding:0;Margin:0">
                <table cellpadding="0" cellspacing="0" class="es-content" align="center" role="none"
                       style="{{$tableClass}};width:100%;table-layout:fixed !important">
                    <tr>
                        <td class="es-info-area" align="center" style="padding:0;Margin:0">
                            <table class="es-content-body" align="center" cellpadding="0" cellspacing="0"
                                   style="{{$tableClass}};background-color:transparent;width:600px"
                ...
                <table cellpadding="0" cellspacing="0" class="es-header" align="center" role="none"
                       style="{{$tableClass}};width:100%;table-layout:fixed !important;background-color:transparent;background-repeat:repeat;background-position:center top">
                    <tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <img
                                                                    src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_887f48b6a2f22ad4fb67bc2a58c0956b/images/93351617889024778.png"
                                                                    alt="Logo"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr class="links">
                                                                        ...
                                                                        <td align="center" valign="top" width="25%"
                                                                            style="Margin:0;border:0;padding-top:15px;padding-bottom:15px;padding-right:5px;padding-left:5px">
                                                                            <a target="_blank" href=""
                                                                               style="mso-line-height-rule:exactly;text-decoration:none;font-family:arial, 'helvetica neue', helvetica, sans-serif;display:block;color:#666666;font-size:14px">New</a>
                                                                        </td>
                                                                        <td align="center" valign="top" width="25%"
                                                                            style="Margin:0;border:0;padding-top:15px;padding-bottom:15px;padding-right:5px;padding-left:5px">
                                                                            <a target="_blank" href=""
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                   cellspacing="0" role="none"
                                   style="{{$tableClass}};background-color:#FFFFFF;width:600px">
                                <tr>
                                    <td align="left"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <img class="adapt-img"
                                                                     src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/90511617967234268.png"
                                                                     alt=""
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-txt-c"
                                                                ...
                                                                <h1 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:46px;font-style:normal;font-weight:bold;line-height:55px;color:#333333">
                                                                    OPENING A NEW STORE</h1></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td class="esdev-adapt-off" align="left"
                                        ...
                                        <table cellpadding="0" cellspacing="0" class="esdev-mso-table" role="none"
                                               style="{{$tableClass}};width:560px">
                                            <tr>
                                                <td class="esdev-mso-td" valign="top" style="padding:0;Margin:0">
                                                    <table cellpadding="0" cellspacing="0" class="es-left" align="left"
                                                           role="none"
                                                           style="{{$tableClass}};float:left">
                                                        <tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" class="es-m-txt-c"
                                                                            ...
                                                                            <img
                                                                                src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/50431617957498582.png"
                                                                                alt=""
                                                                                style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-l"
                                                                            ...
                                                                            <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#333333">
                                                                                Tuesday, January&nbsp;28 | 6:30 - 9:30
                                                                                PM&nbsp;</h3></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                ...
                                <tr>
                                    <td class="esdev-adapt-off" align="left"
                                        style="Margin:0;padding-top:10px;padding-right:20px;padding-left:20px;padding-bottom:5px">
                                        <table cellpadding="0" cellspacing="0" class="esdev-mso-table" role="none"
                                               style="{{$tableClass}};width:560px">
                                            <tr>
                                                <td class="esdev-mso-td" valign="top" style="padding:0;Margin:0">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" class="es-m-txt-c"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img
                                                                                src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/80951617957498354.png"
                                                                                alt=""
                                                                                style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                                width="25" height="25"></td>
                                                                    </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-l"
                                                                            style="padding:0;Margin:0;padding-bottom:5px">
                                                                            <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#333333">
                                                                                4562 Chair Crossing, Kentucky, US,
                                                                                607898</h3></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" class="es-m-txt-c"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img
                                                                                src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/54131617959756485.png"
                                                                                alt=""
                                                                                style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                                width="25" height="25"></td>
                                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <span class="es-button-border"
                                                                      style="border-style:solid;border-color:#5c68e2;background:#5c68e2;border-width:2px;display:block;border-radius:5px;width:auto"><a
                                                                        href=""
                                                                        class="es-button es-button-1621619122263"
                                                                        target="_blank"
                                                                        style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;padding:10px 30px;display:block;background:#5C68E2;border-radius:5px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #5C68E2">REGISTER NOW </a> </span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-bottom:10px;padding-top:15px">
                                                                <span class="es-button-border"
                                                                      style="border-style:solid;border-color:#5c68e2;background:#ffffff;border-width:2px;display:block;border-radius:5px;width:auto"><a
                                                                        href=""
                                                                        class="es-button es-button-1621619122267"
                                                                        target="_blank"
                                                                        style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#5c68e2;font-size:20px;padding:10px 30px;display:block;background:#ffffff;border-radius:5px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #5C68E2;border-color:#ffffff">ADD TO CALENDAR </a> </span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-txt-c"
                                                                style="Margin:0;padding-right:20px;padding-left:20px;padding-bottom:5px;padding-top:15px">
                                                                <h2 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31px;color:#333333">
                                                                    Meet our panelists</h2></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;font-size:0px">
                                                                <img
                                                                    src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/67101617956752886.png"
                                                                    alt=""
                                                                    style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" valign="top"
                                                                            ...
                                                                            <img title="Facebook"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/assets/img/social-icons/logo-colored/facebook-logo-colored.png"
                                                                        ...
                                                                        <td align="center" valign="top"
                                                                            style="padding:0;Margin:0;padding-right:10px">
                                                                            <img title="X.com"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/assets/img/social-icons/logo-colored/x-logo-colored.png"
                                                                        ...
                                                                        <td align="center" valign="top"
                                                                            style="padding:0;Margin:0"><img
                                                                                title="Instagram"
                                                                                src="https://fcwhcpo.stripocdn.email/content/assets/img/social-icons/logo-colored/instagram-logo-colored.png"
                                                ...
                                                <td class="es-m-p20b" align="center"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;font-size:0px">
                                                                <img
                                                                    src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/501617956752886.png"
                                                                    alt=""
                                                                    style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                    width="130" height="130"></td>
                                                        </tr>
                                                ...
                                                <td align="center" style="padding:0;Margin:0;width:173px">
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;font-size:0px">
                                                                <img
                                                                    src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/80871617956752464.png"
                                                                    alt=""
                                                                    style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                    width="130" height="130"></td>
                                                        </tr>
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                            ...
                                            <tr>
                                                <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-bottom:20px;padding-top:15px">
                                                                <h2 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31px;color:#333333">
                                                                    During the event you will learn:</h2></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img class="adapt-img"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/2851617878322771.png"
                                                                                 alt=""
                                                                                 style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" style="padding:0;Margin:0"><p
                                                                                style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                How to pair pieces of clothing to look
                                                                                perfect everywhere.</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td align="left" style="padding:0;Margin:0;width:220px">
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" style="padding:0;Margin:0"><p
                                                                                style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                How to have the&nbsp;coolest outfits&nbsp;this
                                                                                summer.</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td align="left" style="padding:0;Margin:0;width:220px">
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" style="padding:0;Margin:0"><p
                                                                                style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                How to take care of your clothing&nbsp;so
                                                                                it always looks new.</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td align="left" style="padding:0;Margin:0;width:220px">
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" style="padding:0;Margin:0"><p
                                                                                style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                The things you should have in your purse
                                                                                to be ready for any event.</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td align="left" style="padding:0;Margin:0;width:220px">
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" style="padding:0;Margin:0"><p
                                                                                style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                How to look professional yet cool in the
                                                                                office these hot summer days.</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td align="left" style="padding:0;Margin:0;width:220px">
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" style="padding:0;Margin:0"><p
                                                                                style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                10 must-have outfits to look&nbsp;classy,
                                                                                sporty, casual.</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0;width:440px">
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                       ...
                                                                       style="{{$tableClass}}">
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-l es-m-p0t"
                                                                            ...
                                                                            <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                <span style="background-color:#eeeeee">&nbsp; 6:30 - 7:30 PM&nbsp;&nbsp;</span>
                                                                            </p></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-l"
                                                                            style="padding:0;Margin:0;padding-bottom:5px;padding-top:5px">
                                                                            <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#333333">
                                                                                How to pair pieces of clothing
                                                                                correctly</h3></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-l"
                                                                            style="padding:0;Margin:0"><p
                                                                                style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                Learn to create new perfect outfits by
                                                                                using old pieces of clothing.</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-l es-m-p0t"
                                                                            style="padding:0;Margin:0;padding-top:10px">
                                                                            <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                <span style="background-color:#eeeeee">&nbsp; 7:30 - 8:30 PM&nbsp;&nbsp;</span>
                                                                            </p></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-l"
                                                                            style="padding:0;Margin:0;padding-bottom:5px;padding-top:5px">
                                                                            <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#333333">
                                                                                Secrets of excellent photos for social
                                                                                media</h3></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-l"
                                                                            style="padding:0;Margin:0"><p
                                                                                style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                Wanna get famous on Socials? Use our
                                                                                secrets to take perfect photos.</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img
                                                                                src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/17881617959410054.png"
                                                                                alt=""
                                                                                style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                                width="90" height="90"></td>
                                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0;width:440px">
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                       ...
                                                                       style="{{$tableClass}}">
                                                                    <tr>
                                                                        <td align="left" class="es-m-p0t es-m-txt-l"
                                                                            style="padding:0;Margin:0;padding-top:10px">
                                                                            <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                <span style="background-color:#eeeeee">&nbsp; 8:30 - 8:45 PM&nbsp;&nbsp;</span>
                                                                            </p></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-l"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="es-m-p0t es-m-txt-l"
                                                                            style="padding:0;Margin:0;padding-top:10px">
                                                                            <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                <span style="background-color:#eeeeee">&nbsp; 8:45&nbsp;- 9:30 PM&nbsp;&nbsp;</span>
                                                                            </p></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-l"
                                                                            style="padding:0;Margin:0;padding-bottom:5px;padding-top:5px">
                                                                            <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#333333">
                                                                                10 trendy things this year</h3></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left" class="es-m-p0t"
                                                                            style="padding:0;Margin:0;padding-top:5px">
                                                                            <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                Clothing that will help you look perfect
                                                                                wherever you go.</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-txt-c"
                                                                style="Margin:0;padding-right:20px;padding-left:20px;padding-bottom:5px;padding-top:15px">
                                                                <h2 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31px;color:#333333">
                                                                    WE ARE WAITING FOR YOU IN:</h2></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0"><img
                                                                    class="adapt-img" alt="" width="380"
                                                                    src="https://cdt-timer.stripocdn.email/api/v1/images/2R5er3wKMvy6FkHDt0jq2tH95A5H_IO-j_kUKGP8x9E?l=1701851687272"
                                                                    style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <span class="es-button-border"
                                                                      style="border-style:solid;border-color:#5c68e2;background:#5c68e2;border-width:2px;display:block;border-radius:5px;width:auto"><a
                                                                        href=""
                                                                        class="es-button es-button-1621619122274"
                                                                        target="_blank"
                                                                        style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;padding:10px 30px;display:block;background:#5C68E2;border-radius:5px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #5C68E2">REGISTER NOW </a> </span>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <span class="es-button-border"
                                                                      style="border-style:solid;border-color:#5c68e2;background:#ffffff;border-width:2px;display:block;border-radius:5px;width:auto"><a
                                                                        href=""
                                                                        class="es-button es-button-1621619122278"
                                                                        target="_blank"
                                                                        style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#5c68e2;font-size:20px;padding:10px 30px;display:block;background:#ffffff;border-radius:5px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #5C68E2;border-color:#ffffff">ADD TO CALENDAR </a> </span>
                                                            </td>
                                                        </tr>
                                                ...
                                                <td class="es-m-p20b" align="left"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;font-size:0px">
                                                                <img class="adapt-img"
                                                                     src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/79871617963551955.jpg"
                                                                     alt=""
                                                                     style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                        ...
                                                        <tr>
                                                            <td align="left" class="es-m-txt-l"
                                                                style="padding:0;Margin:0;padding-top:10px"><p
                                                                    ...
                                                                    <span style="background-color:#eeeeee">&nbsp; September&nbsp;15, 2021&nbsp;&nbsp;</span>
                                                                </p></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="es-m-txt-l"
                                                                style="padding:0;Margin:0;padding-bottom:5px;padding-top:5px">
                                                                <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#333333">
                                                                    Secrets of effective photos for social media</h3>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0"><p
                                                                    style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                    Wanna get famous on Socials? Use our secrets to take
                                                                    perfect photos.&nbsp;<a target="_blank" href=""
                                                                                            style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">Learn
                                                                        more</a></p></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <span class="es-button-border"
                                                                      style="border-style:solid;border-color:#5c68e2;background:#5c68e2;border-width:2px;display:inline-block;border-radius:5px;width:auto"><a
                                                                        href=""
                                                                        class="es-button es-button-1621619122282"
                                                                        target="_blank"
                                                ...
                                                <td align="left" style="padding:0;Margin:0;width:270px">
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;font-size:0px">
                                                                <img class="adapt-img"
                                                                     src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/65771617963558834.jpg"
                                                                     alt=""
                                                                     style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                     width="270" height="180"></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="es-m-txt-l"
                                                                style="padding:0;Margin:0;padding-top:10px"><p
                                                                    style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px">
                                                                    <span style="background-color:#eeeeee">&nbsp; January&nbsp;28, 2021&nbsp;&nbsp;</span>
                                                                </p></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="es-m-txt-l"
                                                                style="padding:0;Margin:0;padding-bottom:5px;padding-top:5px">
                                                                <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#333333">
                                                                    How to pair pieces of clothing&nbsp;correctly</h3>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0"><p
                                                                    style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                    How to pair pieces of&nbsp;clothing&nbsp;to look
                                                                    perfect and stylish everywhere.&nbsp;<a
                                                                        target="_blank" href=""
                                                                        style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">Learn
                                                                        more</a></p></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <span class="es-button-border"
                                                                      style="border-style:solid;border-color:#5c68e2;background:#5c68e2;border-width:2px;display:inline-block;border-radius:5px;width:auto"><a
                                                                        href=""
                                                                        class="es-button es-button-1621619122285"
                                                                        target="_blank"
                                                                        style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;padding:5px 30px;display:inline-block;background:#5C68E2;border-radius:5px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #5C68E2">REGISTER NOW </a></span>
                                                            </td>
                                                        </tr>
                                ...
                                <tr>
                                    <td class="esdev-adapt-off" align="left"
                                        style="padding:0;Margin:0;padding-right:20px;padding-left:20px;padding-bottom:15px">
                                        <table cellpadding="0" cellspacing="0" class="esdev-mso-table" role="none"
                                               style="{{$tableClass}};width:560px">
                                            <tr>
                                                <td class="esdev-mso-td" valign="top" style="padding:0;Margin:0">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img class="adapt-img"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/85111617963875789.png"
                                                                                 alt=""
                                                                                 style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img class="adapt-img"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/99621617963875792.png"
                                                                                 alt=""
                                                                                 style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                                 width="70" height="70"></td>
                                                                    </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img class="adapt-img"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/61221617963875788.png"
                                                                                 alt=""
                                                                                 style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                                 width="70" height="70"></td>
                                                                    </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img class="adapt-img"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/38811617964094517.png"
                                                                                 alt=""
                                                                                 style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                                 width="70" height="70"></td>
                                                                    </tr>
                                ...
                                <tr>
                                    <td class="esdev-adapt-off" align="left"
                                        style="Margin:0;padding-right:20px;padding-left:20px;padding-top:15px;padding-bottom:30px">
                                        <table cellpadding="0" cellspacing="0" class="esdev-mso-table" role="none"
                                               style="{{$tableClass}};width:560px">
                                            <tr>
                                                <td class="esdev-mso-td" valign="top" style="padding:0;Margin:0">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img class="adapt-img"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/82621617963954583.png"
                                                                                 alt=""
                                                                                 style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                                 width="70" height="70"></td>
                                                                    </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img class="adapt-img"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/25911617963876002.png"
                                                                                 alt=""
                                                                                 style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                                 width="70" height="70"></td>
                                                                    </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img class="adapt-img"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/48761617963875567.png"
                                                                                 alt=""
                                                                                 style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                                 width="70" height="70"></td>
                                                                    </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            style="padding:0;Margin:0;font-size:0px">
                                                                            <img class="adapt-img"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/73151617964094514.png"
                                                                                 alt=""
                                                                                 style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                                 width="70" height="70"></td>
                                                                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table class="es-footer-body" align="center" cellpadding="0" cellspacing="0"
                                   style="{{$tableClass}};background-color:transparent;width:640px"
                                   role="none">
                                <tr>
                                    <td align="left"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" valign="top"
                                                                            ...
                                                                            <img title="Facebook"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                                                        ...
                                                                        <td align="center" valign="top"
                                                                            style="padding:0;Margin:0;padding-right:40px">
                                                                            <img title="X.com"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png"
                                                                        ...
                                                                        <td align="center" valign="top"
                                                                            style="padding:0;Margin:0;padding-right:40px">
                                                                            <img title="Instagram"
                                                                                 src="https://fcwhcpo.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                                                                        ...
                                                                        <td align="center" valign="top"
                                                                            style="padding:0;Margin:0"><img
                                                                                title="Youtube"
                                                                                src="https://fcwhcpo.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png"
