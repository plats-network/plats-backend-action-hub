    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="mb-3">
                <label for="basicpill-expiration-input"
                       class="form-label">Question {{$getInc}}</label>
                {{--Item question--}}
                <input type="text" class="form-control" id="quiz[{{$indexImageItem}}][name]"
                       placeholder="Question {{$getInc}}" name="quiz[{{$indexImageItem}}][name]" >
        ...
        <div class="col-lg-2">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="quiz[{{$indexImageItem}}][time_quiz]"
                       placeholder="Time" name="quiz[{{$indexImageItem}}][time_quiz]" value="">
            </div>
        </div>
        <div class="col-lg-1">
            <div class="mb-3">
    ...
    @for($index2 = 0; $index2<=3; $index2++)
        ...
        <div class="row">
            <div class="mb-3 row offset-md-1">
                ...
                <div class="col-sm-7">
                    {{--name--}}
                    <input type="text" class="form-control" id="quiz[{{$indexImageItem}}][detail][{{$index2}}][name]"
                           placeholder="Answer {{$index2 +1}}" name="quiz[{{$indexImageItem}}][detail][{{$index2}}][name]" value="">
                </div>
                <div class="col-sm-2">

                    <div class="form-check mt-2">
                        {{--status--}}
                        <input class="form-check-input" type="checkbox" value="1" id="quiz[{{$indexImageItem}}][detail][{{$index2}}][status]"
