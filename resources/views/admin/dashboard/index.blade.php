            ...
            <div class="col-12 col-lg-8 mb-5">
                <div class="card sh-45 h-lg-100 position-relative bg-theme">
                    ...
                    <div class="card-img-overlay d-flex flex-column justify-content-end bg-transparent">
                        ...
                        <div>
                            <a href="/Services/Database" class="btn btn-icon btn-icon-start btn-primary mt-3 stretched-link">
                ...
                <div class="scroll-out">
                    <div class="scroll-by-count" data-count="4">
                        <div class="card mb-2 hover-border-primary">
                            <a href="/Services/DatabaseAdd" class="row g-0 sh-9">
                                <div class="col-auto">
                        ...
                        <div class="card mb-2 hover-border-primary">
                            <a href="/Services/Storage" class="row g-0 sh-9">
                                <div class="col-auto">
                                    <div class="sw-9 sh-9 d-inline-block d-flex justify-content-center align-items-center">
                                        <div class="fw-bold text-primary">
                        ...
                        <div class="card mb-2 hover-border-primary">
                            <a href="/Account/Security" class="row g-0 sh-9">
                                <div class="col-auto">
                                    <div class="sw-9 sh-9 d-inline-block d-flex justify-content-center align-items-center">
                                        <div class="fw-bold text-primary">
                        ...
                        <div class="card mb-2 hover-border-primary">
                            <a href="/Services/DatabaseDetail" class="row g-0 sh-9">
                                <div class="col-auto">
                                    <div class="sw-9 sh-9 d-inline-block d-flex justify-content-center align-items-center">
                                        <div class="fw-bold text-primary">
                        ...
                        <div class="card mb-2 hover-border-primary">
                            <a href="/Support/Docs" class="row g-0 sh-9">
                                <div class="col-auto">
                                    <div class="sw-9 sh-9 d-inline-block d-flex justify-content-center align-items-center">
                                        <div class="fw-bold text-primary">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="d-flex flex-column sh-5">
                                    <a href="/Support/KnowledgeBase" class="heading stretched-link">Application Launch</a>
                                </div>
                            </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="d-flex flex-column sh-5">
                                    <a href="/Support/KnowledgeBase" class="heading stretched-link">Performance Tweaks</a>
                                </div>
                            </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="d-flex flex-column sh-5">
                                    <a href="/Support/KnowledgeBase" class="heading stretched-link">Advanced Configuration</a>
                                </div>
                            </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="d-flex flex-column sh-5">
                                    <a href="/Support/KnowledgeBase" class="heading stretched-link">Server Analytics</a>
                                </div>
                            </div>
