        ...
        <div class="row g-2 row-cols-1 row-cols-xl-2 row-cols-xxl-4">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ asset('img/admin/content/icon-launch.webp') }}" class="theme-filter" alt="launch" />
                            <div class="d-flex flex-column sh-5">
                                <a href="#" class="heading stretched-link">Application Launch</a>
                            </div>
                        </div>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ asset('img/admin/content/icon-performance.webp') }}" class="theme-filter" alt="performance" />
                            <div class="d-flex flex-column sh-5">
                                <a href="#" class="heading stretched-link">Performance Tweaks</a>
                            </div>
                        </div>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ asset('img/admin/content/icon-configure.webp') }}" class="theme-filter" alt="configure" />
                            <div class="d-flex flex-column sh-5">
                                <a href="#" class="heading stretched-link">Advanced Configuration</a>
                            </div>
                        </div>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ asset('img/admin/content/icon-analytics.webp') }}" class="theme-filter" alt="analytics" />
                            <div class="d-flex flex-column sh-5">
                                <a href="#" class="heading stretched-link">Server Analytics</a>
                            </div>
                        </div>
