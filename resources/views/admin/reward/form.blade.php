<x-alert/>
<x-form::open :action="route(REWARD_STORE_ADMIN_ROUTER)" files="true">
    ...
    <div class="row">
        <div class="col-12 mb-5">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="card">
                        <div class="card-body">
                            <div class="col-lg-6">
                                <x-forms.group :label="trans('admin.reward.form.type')">
                                    <x-forms.select name="type" select2 required
                                                    :options="trans('admin.reward.type')"
                                                    :selected="old('type')"/>
                                </x-forms.group>
                            </div>
                            <x-forms.group :label="trans('admin.reward.form.name')">
                                <x-forms.input name="name" :value="old('name')" required/>
                            </x-forms.group>

                            <x-forms.group :label="trans('admin.reward.form.desc')">
                                <x-forms.textarea name="address" :value="old('address')" required/>
                            </x-forms.group>

                            <x-forms.group :label="trans('admin.reward.form.phone')">
                ...
                <div class="col-lg-5">
                    <div class="card mb-3">
                        <div class="card-body">
                            <x-form::label :label="trans('admin.reward.form.logo')"/>
            ...
            <div class="mt-3">
                <a href="{{ route(REWARD_LIST_ADMIN_ROUTER) }}" class="btn btn-icon btn-icon-start btn-outline-info">
